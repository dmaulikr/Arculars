...
struct Strings {
    ...
    static let SharingText        = "OMG! Check out my score in #ARCULARS! Download on " + ArcularsAppStore
    
    static let LeaderboardEndless = "leaderboard.endless"
    static let LeaderboardTimed   = "leaderboard.timed"
}